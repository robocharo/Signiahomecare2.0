...
COMPREHENSIVE_SERVICES = [
    {
        ...
        "name":       "Private Duty Nursing (Home Care Nursing)",
        "short":      "Continuous one-on-one RN or LPN nursing in the home for complex, ongoing needs.",
        "icon":       "🩹",
        "category":   "comprehensive",
        "category_label": "Comprehensive Home Care",
        "meta_title": "Private Duty Nursing (Home Care Nursing) | Signia Home Care Minneapolis MN",
        "meta_desc":  "Private duty nursing — also called home care nursing — in Minneapolis and the Twin Cities. Continuous one-on-one RN and LPN care at home under our Minnesota Comprehensive Home Care license.",
        "hero_headline":    "Private Duty Nursing",
        "hero_sub":         "Continuous One-on-One Nursing Care at Home",
        "intro":            "When a health condition requires more individual, hands-on nursing than a brief visit can provide, private duty nursing brings a Registered Nurse or Licensed Practical Nurse into the home for extended, one-on-one care. It is the flagship nursing service we provide under our Minnesota Comprehensive Home Care license.",
        "description":      "Private duty nursing — known in Minnesota as Home Care Nursing (HCN) and federally as Private Duty Nursing — provides ongoing professional nursing observation, monitoring, intervention, and evaluation for individuals whose needs are greater than a Home Health Aide or Personal Care Assistant can meet, and require more time than an intermittent nurse visit. Our RNs and LPNs deliver care in shifts, following a physician, advanced practice nurse, or physician assistant order and an individualized plan of care.",
        "who_benefits":     [
            "Individuals with complex medical conditions needing hours of continuous nursing",
            "People dependent on ventilators, tracheostomies, tube feedings, or IV therapy",
            "Medically fragile children and adults on Medical Assistance or a waiver program",
            "Families who need dependable, one-on-one skilled nursing presence in the home",
        ],
        "how_it_helps":     [
            "Delivers extended, continuous nursing rather than brief intermittent visits",
            "Supports safe living at home for people with high-acuity medical needs",
            "Provides close monitoring that helps prevent avoidable hospital stays",
            "Coordinates directly with physicians and the broader care team",
        ],
        "what_to_expect":   "Private duty nursing begins with an order from your physician, advanced practice nurse, or physician assistant and, for members of Minnesota Health Care Programs or a waiver, prior authorization. A nurse completes an assessment and plan of care, and RN or LPN shifts are scheduled to match your needs. Services are individualized based on assessment, orders, and program eligibility.",
        "why_signia":       "Private duty nursing is at the heart of what our Comprehensive Home Care license allows us to do. Signia Home Care's nurses combine real clinical skill with genuine warmth, providing the steady, one-on-one presence that keeps people safe and comfortable at home.",
    },
    {
    ...
    },
    {
        ...
        "short":      "RN assessments, care planning, wound care, and clinical oversight in the home.",
        "icon":       "💉",
        "category":   "comprehensive",
        "category_label": "Comprehensive Home Care",
        "meta_title": "Registered Nurse Services | Signia Home Care Minneapolis MN",
        "meta_desc":  "Registered nurse home care in Minneapolis and the Twin Cities. Assessments, care planning, wound care, medication oversight, and nurse delegation under our Comprehensive Home Care license.",
        "hero_headline":    "Registered Nurse Services",
        "hero_sub":         "Professional Nursing Care Delivered with Compassion",
        "intro":            "Having a Registered Nurse (RN) involved in care at home provides peace of mind for both clients and families. Our RNs bring clinical skill and genuine warmth to every visit, helping individuals manage health conditions and stay safely at home.",
        "description":      "Registered Nurses with Signia Home Care may perform health assessments, monitor vital signs, manage wound care, oversee medication regimens, educate clients and caregivers, and coordinate with physicians and the care team. Our RNs also lead private duty (home care) nursing, and they assess, train, delegate, and supervise care tasks performed by home care aides — all within the scope of our Minnesota Comprehensive Home Care license.",
        "who_benefits":     [
            "Individuals managing chronic or complex conditions at home",
            "Clients who need wound care, IV therapy oversight, or medication management",
            "Families who want professional nursing assessment and care planning",
            "Households where trained aides carry out nurse-delegated care tasks",
        ],
        "how_it_helps":     [
            "Monitors health status to detect and respond to changes early",
            "Builds and updates an individualized plan of care",
            "Educates clients and family members to support confidence and safety",
            "Extends clinical oversight into everyday home care through nurse delegation",
        ],
        "what_to_expect":   "An RN will conduct an in-home assessment to understand your needs and goals. From there, a personalized plan of care is developed and services are scheduled accordingly. Communication with your physician or care team is an important part of this process. Services are individualized based on assessment and program fit.",
        "why_signia":       "Signia Home Care's registered nurses are more than clinicians — they are advocates for your well-being. We hold a Minnesota Comprehensive Home Care license and are committed to safe, high-quality, person-centered nursing care.",
    },
    {
        "slug":       "licensed-practical-nurse-services",
        "name":       "Licensed Practical Nurse Services",
        "short":      "Hands-on nursing support under RN and physician direction.",
        "icon":       "🏥",
        "category":   "comprehensive",
        "category_label": "Comprehensive Home Care",
        "meta_title": "Licensed Practical Nurse Services | Signia Home Care Minneapolis MN",
        "meta_desc":  "LPN home care in Minneapolis and the Twin Cities. Hands-on nursing tasks, wound care support, and private duty nursing under RN direction and our Comprehensive Home Care license.",
        "hero_headline":    "Licensed Practical Nurse Services",
        "hero_sub":         "Hands-On, Professional Nursing Support in Your Home",
        "intro":            "Licensed Practical Nurses (LPNs) are an essential part of a professional home care team. Working under the direction of a Registered Nurse or physician, our LPNs deliver reliable, hands-on clinical support that helps individuals manage their health and stay comfortable at home.",
        "description":      "LPNs at Signia Home Care may assist with wound care, monitor vital signs, administer medications as directed, staff private duty (home care) nursing shifts, and provide education to clients and family members — all under RN and physician direction. They work as part of a coordinated care team, ensuring consistent, quality care.",
        "who_benefits":     [
            "Clients who need regular nursing tasks such as wound care or vital sign monitoring",
            "Individuals managing chronic illness who need consistent clinical support",
            "People who benefit from hands-on care delivered by a licensed nurse",
            "Families seeking dependable, professional nursing support",
        ],
        "how_it_helps":     [
            "Delivers consistent, hands-on nursing under RN and physician direction",
    ...
    },
    {
        ...
        "meta_desc":  "Home medication management in Minneapolis and Twin Cities. Professional nursing oversight to help clients take the right medication safely, at the right time.",
        "hero_headline":    "Medication Management Services",
        "hero_sub":         "The Right Medication, at the Right Time, Every Time",
        "intro":            "Managing multiple medications can be confusing and even dangerous without proper support. Our professional nursing team provides expert medication management to help individuals take their medications correctly, avoid harmful interactions, and stay safe at home.",
